...
- **Support / Donate** — Thank-you page with PayPal donation link
- **Ad Placeholder** — Shown during alarm investigation loading state
...
├── ContentView.swift           # Tab navigation (Today / History / Settings / Support)
